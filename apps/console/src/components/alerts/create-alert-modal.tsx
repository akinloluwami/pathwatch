...
export function CreateAlertModal({ isOpen, onClose, onSubmit }: CreateAlertModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative w-full max-w-2xl mx-4 border border-gray-800 bg-black shadow-2xl">
        <Brackets />
        ...
        <form onSubmit={handleSubmit} className="px-6 py-6 space-y-6">
          ...
          <div>
            ...
            {formData.channels.length === 0 && (
              <p className="mt-2 text-xs text-red-400">Select at least one notification channel</p>
            )}
          </div>
